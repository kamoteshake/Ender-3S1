...
#if HAS_TEMPERATURE && ANY(HAS_LCD_MENU, DWIN_CREALITY_LCD, RTS_AVAILABLE) //EITHER(HAS_LCD_MENU, DWIN_CREALITY_LCD, RTS_AVAILABLE)
...
#if ANY(G38_PROBE_TARGET, CNC_COORDINATE_SYSTEMS, POWER_LOSS_RECOVERY, CREALITY_POWER_LOSS)
