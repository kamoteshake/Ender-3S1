...
#define USER_STM32F401  1
  ...
  #ifndef SHORT_BUILD_VERSION
    #if ENABLED(Z_AXIS_LIMIT_MODE)
      #define SHORT_BUILD_VERSION "24ZCF_0.0.3" //F103版本
    #elif ENABLED(USER_STM32F103)
      #define SHORT_BUILD_VERSION "24F1CF_0.0.3" //F103版本
    #elif ENABLED(USER_STM32F401)
      #define SHORT_BUILD_VERSION "24F4CF_0.0.3" // F401版本
    #endif
  #endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 420.7} // KS E step calibration
