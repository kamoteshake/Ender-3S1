...
#define USER_STM32F401  1
  ...
  #define FIRMWARE_VERSION  "24F4CF"
  #define SCREEN_VERSION    "UI20"
  #define SCREEN_HW_VERSION "DWIN2021"
  #define HARDWARE_VERSION  "CR-FDM-v24S1_301"
  #define PRINT_SIZE        "300 * 300 * 300"
  #define CORP_WEBSITE_C    "www.cxsw3d.com  "
  #define CORP_WEBSITE_E    "www.creality.com"
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  14.49,  22.20 }
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 10//20 // If the temperature difference between the target temperature and the actual temperature
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 425.10} // KS E step calibration -- Stock Gear Idler
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 442.66} // KS E step calibration -- Bearing Idler
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          {300 , 300 , 5 , 25} //{ 3000, 3000, 60, 25 }   // 最大进给率
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 }  //加速度//{ 500, 500, 100, 1000 }  //加速度
...
#define Z_AFTER_PROBING            10 // KS - apply z after probing // Z position after probing is done
...
/*不打印的时候（打印机暂停），无法移动电机，防止丢步造成的打印出错*/
...
#define Z_AFTER_HOMING  10   // KS   // (mm) Height to move to after homing Z
...
#elif ENABLED(ENDER_3S1_PLUS)
  //                                     X0,Y0    X1,Y1   X2,Y2  X3,Y3    X4 Y4
  #define MANUALL_BED_LEVEING_5POSITION {150,150, 30,30, 270,30, 270,270, 30,270}
#endif
...
#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    #define ABL_BILINEAR_SUBDIVISION
      ...
      #define BILINEAR_SUBDIVISIONS 5//3
    #endif
 ...
 *此功能可校正 XYZ 轴的错位。
 *
 *采取以下步骤来获得 XY 平面中的床倾斜：
 *1. 打印一个测试方块（例如，https://www.thingiverse.com/thing:2563185）
 *2. 对于 XY_DIAG_AC 测量对角线 A 到 C
 *3. 对于 XY_DIAG_BD 测量 B 到 D 的对角线
 *4. 对于 XY_SIDE_AD 测量边缘 A 到 D
 *
 *Marlin 会根据这些测量值自动计算偏斜系数。
 *偏斜因子也可以手动计算和设置：
 *
 *-计算 AB : SQRT(2*AC*AC+2*BD*BD-4*AD*AD)/2
 *-XY_SKEW_FACTOR : TAN(PI/2-ACOS((AC*AC-AB*AB-AD*AD)/(2*AB*AD)))
 *
 *如果需要，对 XZ 和 YZ 执行相同的步骤。
 *使用这些图表作为参考：
 */
 ...
 *打印作业计时器
 *
 *自动启动和停止 M104/M109/M190 上的打印作业定时器。
 *
 *M104 (hotend, no wait) -高温 = 无，低温 = 停止计时器
 *M109（热端，等待） -高温 = 启动计时器，低温 = 停止计时器
 *M190（床上，等待）-高温 = 启动计时器，低温 = 无
 *
 *定时器也可以通过以下命令控制：
 *
 *M75 -启动打印作业计时器
...
// menu key press reset wifi
// #define HAS_MENU_RESET_WIFI